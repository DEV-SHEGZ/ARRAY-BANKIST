...
This time they are want to figure out if the dogs in their are 
...
const testFood = function (dog) {
  if (dog.curFood > dog.recFood * 0.9 && dog.curFood < dog.recFood * 0.9) {
    console.log("Dog is eating right");
  } else {
    console.log("Dog is not eating right");
  }
};
...
const dogsLess = dogs
  ...
  .map((dog) => dog.owners)
  .flat();
console.log(dogsLess);

//Exercise 4
console.log(dogsLess.join(" and ") + " Dogs eat too much.");
console.log(dogsMuch.join(" and ") + " Dogs eat too much.");

//Exercise 5
const sameAmount = dogs.find((dog) => dog.curFood === dog.recFood);
